...
Begin VB.Form frmHouse 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      EndProperty
      TabCaption(0)   =   "Casa"
      TabPicture(0)   =   "frmHouse.frx":0000
      ...
      Tab(0).Control(6)=   "scrlItem"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "scrlCost"
      ...
      Begin Eclipse.jcbutton cmdOk 
         ...
         BackColor       =   14935011
         Caption         =   "Aceptar"
         PictureNormal   =   "frmHouse.frx":001C
         PictureHot      =   "frmHouse.frx":0800
      ...
      Begin Eclipse.jcbutton cmdCancel 
         ...
         BackColor       =   14935011
         Caption         =   "Cancelar"
         PictureNormal   =   "frmHouse.frx":0FE4
         PictureHot      =   "frmHouse.frx":1938
         PictureEffectOnOver=   0
         PictureEffectOnDown=   0
         PicturePushOnHover=   -1  'True
         CaptionEffects  =   4

...
Begin VB.Form frmNewShop 
   ...
   Begin VB.PictureBox imgBox 
      ...
      End
   End
   Begin Eclipse.jcbutton lblSell 
      Height          =   375
      Left            =   480
      TabIndex        =   35
      Top             =   4440
...
Public Sub showPage(ByVal page As Integer)
    ...
    For I = 1 To 5
        ...
        Else
            ...
            lblItem(I - 1).Caption = itemName & vbNewLine & "Precio: " & STR(Shop(shopNum).ShopItem(pageIndex * 5 + I).Price) & " " & shopCurrency
...
Private Sub cmdNext_Click()
    If pageIndex = maxpages - 1 Then Exit Sub
    pageIndex = pageIndex + 1
    Call showPage(pageIndex)
End Sub
...
Private Sub Form_Load()
    ...
    For I = 1 To 3
        ...
        If FileExists("GUI\Tienda" & Ending) Then
            Me.Picture = LoadPicture(App.Path & "\GUI\Tienda" & Ending)
        End If
    Next I
End Sub

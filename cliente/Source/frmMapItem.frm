...
Begin VB.Form frmMapItem 
   ...
   Caption         =   "Añadir un objeto al mapa"
   ClientHeight    =   2625
   ClientLeft      =   60
   ClientTop       =   375
   ClientWidth     =   5310
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin Eclipse.jcbutton cmdOk 
         ...
         BackColor       =   14935011
         Caption         =   "Aceptar"
         PictureNormal   =   "frmMapItem.frx":0FDE
         PictureHot      =   "frmMapItem.frx":17C2
      ...
      Begin Eclipse.jcbutton cmdCancel 
         ...
         BackColor       =   14935011
         Caption         =   "Cancelar"
         PictureNormal   =   "frmMapItem.frx":1FA6
         PictureHot      =   "frmMapItem.frx":28FA
         PictureEffectOnOver=   0
         PictureEffectOnDown=   0
         PicturePushOnHover=   -1  'True
         CaptionEffects  =   4

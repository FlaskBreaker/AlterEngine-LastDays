...
Sub GameLoop()
    ...
    Do While InGame
        ...
        If frmMirage.WindowState = 0 Then
            ...
            ' Solución al fallo de congelación de mapas
            ' Añadido por Stream
        ...
        If frmMirage.chkNpcBar.value = Checked Then
                ...
                If ScreenMode = 0 Then
                    ...
                    If BLoc Then
                        ...
                        Call DrawText(TexthDC, 0 + sx, 15 + sx, "Localización (X: " & GetPlayerX(MyIndex) & "; Y: " & GetPlayerY(MyIndex) & ")", QBColor(YELLOW))
...
Sub HandleKeypresses(ByVal KeyAscii As Integer)
    ...
    If (KeyAscii = vbKeyReturn) Then
        ...
        If Mid$(MyText, 1, 1) = "!" Then
            ...
            Else
                Call AddText("Usa: !nombredeljugador mensaje aquí", AlertColor)
            End If
            MyText = vbNullString
            Exit Sub
        End If
        ...
        ' Añadido en v1.3 para posibilidad de editar scripts cualquier GM
        ...
        If GetPlayerAccess(MyIndex) > 0 Then
            ...
            If LCase$(Mid$(MyText, 1, 13)) = "/limpiardueño" Then

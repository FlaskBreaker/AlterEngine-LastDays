...
Begin VB.Form frmMinusStat 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin Eclipse.jcbutton cmdOk 
         ...
         BackColor       =   14935011
         Caption         =   "Aceptar"
         PictureNormal   =   "frmMinusStat.frx":001C
         PictureHot      =   "frmMinusStat.frx":0800
      ...
      Begin Eclipse.jcbutton cmdCancel 
         ...
         BackColor       =   14935011
         Caption         =   "Cancelar"
         PictureNormal   =   "frmMinusStat.frx":0FE4
         PictureHot      =   "frmMinusStat.frx":1938
         PictureEffectOnOver=   0
         PictureEffectOnDown=   0
         PicturePushOnHover=   -1  'True
         CaptionEffects  =   4
      ...
      Begin VB.Label Label4 
         Caption         =   "Mensaje (si no cumple los requerimientos) :"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   6.75
            Charset         =   0
